...
public class RedwoodMegaTrunkPlacer extends TrunkPlacer {
    public static final Codec<RedwoodMegaTrunkPlacer> CODEC = RecordCodecBuilder.create(redwoodTrunkPlacerInstance ->
            trunkPlacerParts(redwoodTrunkPlacerInstance).apply(redwoodTrunkPlacerInstance, RedwoodMegaTrunkPlacer::new));

    public RedwoodMegaTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return REOTrunkPlacers.REDWOOD_MEGA_TRUNK_PLACER.get();
    }
