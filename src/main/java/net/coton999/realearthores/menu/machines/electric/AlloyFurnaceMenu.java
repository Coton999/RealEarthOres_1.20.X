...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    public final AlloyFurnaceBE blockEntity;
    ...
    public AlloyFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = ((AlloyFurnaceBE) entity);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 8, 53));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, REOBlocks.ELECTRIC_ALLOY_FURNACE.get());
    }
