...
import net.coton999.realearthores.block.entity.machines.electric.CentrifugeBE;
...
public class CentrifugeMenu extends AbstractContainerMenu {
    public final CentrifugeBE blockEntity;
    ...
    public CentrifugeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(REOMenuTypes.CENTRIFUGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((CentrifugeBE) entity);
