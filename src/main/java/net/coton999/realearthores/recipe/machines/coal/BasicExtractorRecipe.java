...
public class BasicExtractorRecipe extends AbstractCookingRecipe {
    public BasicExtractorRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(REOBlocks.EXTRACTOR.get());
    }
    ...
    public static class Type implements RecipeType<BasicExtractorRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<BasicExtractorRecipe> {
        private final int defaultCookingTime;
        public static final BasicExtractorRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public BasicExtractorRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new BasicExtractorRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public BasicExtractorRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, BasicExtractorRecipe pRecipe) {
