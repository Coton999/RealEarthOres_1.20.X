...
public class KilnRecipe implements Recipe<SimpleContainer> {
    ...
    public KilnRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputItems) {
