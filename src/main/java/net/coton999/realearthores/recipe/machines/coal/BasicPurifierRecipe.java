...
public class BasicPurifierRecipe extends AbstractCookingRecipe {
    public BasicPurifierRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(REOBlocks.PURIFIER.get());
    }
    ...
    public static class Type implements RecipeType<BasicPurifierRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<BasicPurifierRecipe> {
        private final int defaultCookingTime;
        public static final BasicPurifierRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public BasicPurifierRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new BasicPurifierRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public BasicPurifierRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, BasicPurifierRecipe pRecipe) {
