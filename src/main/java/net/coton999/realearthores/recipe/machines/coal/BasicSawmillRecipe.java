...
public class BasicSawmillRecipe extends AbstractCookingRecipe {
    public BasicSawmillRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(REOBlocks.SAWMILL.get());
    }
    ...
    public static class Type implements RecipeType<BasicSawmillRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<BasicSawmillRecipe> {
        private final int defaultCookingTime;
        public static final BasicSawmillRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public BasicSawmillRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new BasicSawmillRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public BasicSawmillRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, BasicSawmillRecipe pRecipe) {
