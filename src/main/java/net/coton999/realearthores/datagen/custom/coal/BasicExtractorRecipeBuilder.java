...
public class BasicExtractorRecipeBuilder implements RecipeBuilder {
    ...
    public BasicExtractorRecipeBuilder(ItemLike pResult, Ingredient pIngredient, float pExperience, int pCookingTime) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return net.coton999.realearthores.recipe.machines.coal.BasicExtractorRecipe.Serializer.INSTANCE;
        }
