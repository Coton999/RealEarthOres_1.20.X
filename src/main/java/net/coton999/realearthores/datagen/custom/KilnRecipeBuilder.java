...
public class KilnRecipeBuilder implements RecipeBuilder {
    ...
    public KilnRecipeBuilder(RecipeCategory pCategory, ItemLike pResult, ItemLike pIngredient, float pExperience, int pCookingTime) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new KilnRecipeBuilder.Result(pRecipeId, this.ingredient, this.result, this.experience, this.cookingTime, this.advancement,
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return KilnRecipe.Serializer.INSTANCE;
        }
