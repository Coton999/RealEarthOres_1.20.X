...
public class BasicCompressorRecipeCategory implements IRecipeCategory<BasicCompressorRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(RealEarthOres.MOD_ID, "basic_compressor");
    public static final ResourceLocation TEXTURE = new ResourceLocation("jei", "textures/jei/gui/gui_vanilla.png");

    public static final RecipeType<BasicCompressorRecipe> BASIC_COMPRESSOR_TYPE =
            new RecipeType<>(UID, BasicCompressorRecipe.class);
    ...
    public BasicCompressorRecipeCategory(IGuiHelper guiHelper, int regularCookTime) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(REOBlocks.COMPRESSOR.get()));
    ...
    @Override
    public mezz.jei.api.recipe.RecipeType<BasicCompressorRecipe> getRecipeType() {
        return BASIC_COMPRESSOR_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Coal Compressing");
    }
    ...
    protected IDrawableAnimated getArrow(BasicCompressorRecipe recipe) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicCompressorRecipe recipe, IFocusGroup focuses) {
