...
public class ElectricFurnaceRecipeCategory implements IRecipeCategory<ElectricFurnaceRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(RealEarthOres.MOD_ID, "electric_furnace");
    public static final ResourceLocation TEXTURE = new ResourceLocation(RealEarthOres.MOD_ID,
            "textures/gui/container/machine/electric/basic/machine.png");

    public static final RecipeType<ElectricFurnaceRecipe> ELECTRIC_FURNACE_TYPE =
            new RecipeType<>(UID, ElectricFurnaceRecipe.class);
    ...
    public ElectricFurnaceRecipeCategory(IGuiHelper guiHelper, int regularCookTime) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(REOBlocks.ELECTRIC_FURNACE.get()));
    ...
    public RecipeType<ElectricFurnaceRecipe> getRecipeType() {
        return ELECTRIC_FURNACE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Electric Smelting");
    }
    ...
    protected IDrawableAnimated getArrow(ElectricFurnaceRecipe recipe) {
        int cookTime = 200;
        if (cookTime <= 0) {
    ...
    public void draw(ElectricFurnaceRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    protected void drawCookTime(ElectricFurnaceRecipe recipe, GuiGraphics guiGraphics, int y) {
        int cookTime = 200;
        if (cookTime > 0) {
