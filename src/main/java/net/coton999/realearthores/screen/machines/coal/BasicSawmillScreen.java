...
public class BasicSawmillScreen extends AbstractFurnaceScreen<BasicSawmillMenu> {
    ...
    public BasicSawmillScreen(BasicSawmillMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
