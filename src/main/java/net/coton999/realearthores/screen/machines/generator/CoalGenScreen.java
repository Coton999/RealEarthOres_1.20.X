package net.coton999.realearthores.screen.machines.generator;
...
public class CoalGenScreen extends AbstractContainerScreen<CoalGenMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(RealEarthOres.MOD_ID,"textures/gui/container/machine/generator/generator.png");
    private EnergyDisplayTooltipArea energyInfoArea;

    public CoalGenScreen(CoalGenMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
